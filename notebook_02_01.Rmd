...
```{r load data}
colleges <- read.csv("https://raw.githubusercontent.com/lawrence-midd/soan385/spring2019/college_mobility.csv")
```
...
Let's do a quick review of the functions we looked at last week. If you want to know how many colleges in this data frame are in each region, how would you do so? Based on the table, what is the *modal value* of the `region` variable?
