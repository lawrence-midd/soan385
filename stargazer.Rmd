...
- `type = "latex"` converts the output into the Latex language that pandoc needs to knit to a PDF. Latex is the default so you can leave it off if you want. To change to  output you could use for a web publication, change `type = "latex"` to `type = "html"`.
