...
We'll use the `gss_week11.csv` file on Canvas. Load it as a data frame called `gss_week11` and load the usual packages.

```{r, include=FALSE, warning=FALSE}
library(tidyverse)
library(pander)
gss_week11 <- read.csv("gss_week11.csv")
```
...
The r-squared value is the proportional reduction in the error from using the model. We'll calculate r-squared for the model regressing number of memberships on years of education.
