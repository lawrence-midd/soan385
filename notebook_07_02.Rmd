...
Can you reject the null hypothesis that the mean of `ideal_childs` in the full sample differs from 2.41 at the .05 alpha level?

### REPLACE THIS LINE WITH YOUR CODE ###

Can you reject the null hypothesis that the mean of `ideal_childs` in the full sample differs from 2.41 at the .01 alpha level?
